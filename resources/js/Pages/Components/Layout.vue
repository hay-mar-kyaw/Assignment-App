<template>
    <div>
        ...
        <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            <div class="h-full px-3 py-4 overflow-y-auto bg-indigo-200">
                <Link href="/admin/dashboard" class="flex items-center ps-2.5 mb-5">
                    <img src="https://flowbite.com/docs/images/logo.svg" class="h-6 me-3 sm:h-7" alt="Flowbite Logo" />
                    <span class="self-center text-xl font-semibold whitespace-nowrap">Admin Panel</span>
                </Link>
                <ul class="space-y-2 font-medium">
                    <li>
                        <Link href="/admin/items" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-indigo-500 hover:text-white group">
                    ...
                    <li>
                        <Link href="/admin/categories" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-indigo-500 hover:text-white group">
                    ...
                    <li>
                        <Link href="admin/login" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-indigo-500 hover:text-white group">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 16">
