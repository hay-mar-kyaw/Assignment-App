<template>
    <Layout>
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <Link href="/admin/items" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600">
                Items
            </Link>
            </li>
            ...
            <div class="flex items-center">
                ...
                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2">Add Item</span>
            </div>
            </li>
        </ol>
        </nav>
        ...
        <div class="w-full bg-white   border border-gray-200 rounded-lg shadow">
            <div class="w-full bg-indigo-500 p-3 rounded-t-md">
                Add Items
            </div>
            <!-- Item Create Form -->
            <form @submit.prevent="storeItem">

                <div class="grid md:grid-cols-2 gap-6 p-3">
                    <div class="first-col">
                        <h5 class="py-3">Item Information</h5>
                        <div class="mb-5">
                            <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900">Item Name</label>
                            <input v-model="form.name" type="text" id="first_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Input Name" required>
                        </div>
                        <div class="mb-5">
                            <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900">Select Category</label>
                            <select v-model="form.category_id" id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        ...
                        <div class="mb-5">
                            <label for="company" class="block mb-2 text-sm font-medium text-gray-900">Price</label>
                            <input v-model="form.price" type="text" id="company" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Enter Price" required>
                        </div>
                        <div class="mb-5">
                            <label for="phone" class="block mb-2 text-sm font-medium text-gray-900">Description</label>
                            <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50">
                                ...
                                <div class="px-4 py-2 bg-white rounded-b-lg">
                                    ...
                                    <textarea v-model="form.description" id="editor" rows="8" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 focus:ring-0" placeholder="Enter Description" required></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="mb-5">
                            <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900">Select Item Condition</label>
                            <select v-model="form.item_condition" id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                <option value="" selected>Select Item Condition</option>
                                <option value="new">New</option>
                                <option value="used">Used</option>
                            </select>
                        </div>
                        <div class="mb-5">
                            <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900">Select Item Type</label>
                            <select v-model="form.item_type" id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        ...
                        <div class="mb-5">
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-900">Item Photo</label>
                    ...
                    <div class="second-col">
                        <h5 class="py-3">Owner Information</h5>
                        <div class = "mb-5">
                            <label for="website" class="block mb-2 text-sm font-medium text-gray-900">Owner Name</label>
                            <input v-model="form.owner_name" type="url" id="website" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Input Owner Name" required>
                        </div>
                        <div class = "mb-5">
                            <label for="website" class="block mb-2 text-sm font-medium text-gray-900">Contact Number</label>
                            <div class="flex items-center">
                                ...
                                +95 <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/></svg>
                                </button>
                                ...
                                <div class="relative w-full">
                                    <input v-model="form.owner_contact_number" type="text" id="phone-input" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg border-s-0 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Add Number" required>
                                </div>
                            </div>
                        </div>
                        <div class = "mb-5">
                            <label for="website" class="block mb-2 text-sm font-medium text-gray-900">Address</label>
                            <textarea v-model="form.owner_address" id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Enter Address"></textarea>
                        </div>
                        <div class="mb-2 float-right">
                                ...
                                <button type="submit" class="text-white bg-indigo-500 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Save</button>
                        </div>
                    </div>
                </div>
            </form>
...
const form=useForm({
    name: '',
    category_id: null, // Assuming category_id is part of your form
    price: 0, // Assuming price is a number field
    description: '',
    item_condition: '',
    item_type: '',
    status: false,
